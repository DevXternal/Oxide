...
local DarkMainFrame = Instance.new("Frame")
...
TextLabel_9.Text = "darkmode - Dark mode for CMDBAR"
...
DarkMainFrame.Name = "DarkMainFrame"
DarkMainFrame.Parent = gui
DarkMainFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
DarkMainFrame.BorderSizePixel = 0
DarkMainFrame.Position = UDim2.new(0.697848558, 0, 0.247971132, 0)
DarkMainFrame.Size = UDim2.new(0.113017425, 0, 0.0879170448, 0)
DarkMainFrame.Visible = false

title_2.Name = "title"
title_2.Parent = DarkMainFrame
title_2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
title_2.BorderSizePixel = 0
title_2.Position = UDim2.new(0, 0, -0.0111555159, 0)
title_2.Size = UDim2.new(1, 0, 0.333333343, 0)
title_2.Font = Enum.Font.Michroma
title_2.Text = "Trioxide"
title_2.TextColor3 = Color3.fromRGB(255, 255, 255)
title_2.TextScaled = true
title_2.TextSize = 14.000
title_2.TextWrapped = true

TextBox_2.Parent = DarkMainFrame
TextBox_2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
TextBox_2.BorderSizePixel = 0
TextBox_2.Position = UDim2.new(0, 0, 0.597236097, 0)
TextBox_2.Size = UDim2.new(1, 0, 0.397435904, 0)
TextBox_2.Font = Enum.Font.SourceSans
TextBox_2.PlaceholderText = "Command Bar (')"
TextBox_2.Text = ""
...
local function ONFY_fake_script() -- TextBox.Functions 
...
coroutine.wrap(ONFY_fake_script)()
local function FYQX_fake_script() -- MainFrame.Dragify 
...
coroutine.wrap(FYQX_fake_script)()
local function QVTD_fake_script() -- MainFrame.ChatCmds 
	local script = Instance.new('LocalScript', MainFrame)
...
coroutine.wrap(QVTD_fake_script)()
local function GYJYBB_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(GYJYBB_fake_script)()
local function TGBN_fake_script() -- TextBox_2.Functions 
...
coroutine.wrap(TGBN_fake_script)()
local function NGPYPJL_fake_script() -- DarkMainFrame.Dragify 
	local script = Instance.new('LocalScript', DarkMainFrame)
...
coroutine.wrap(NGPYPJL_fake_script)()
local function COAH_fake_script() -- DarkMainFrame.ChatCmds 
	local script = Instance.new('LocalScript', DarkMainFrame)
...
coroutine.wrap(COAH_fake_script)()
